...
MAIN = main.c
CC = avr-gcc
SRC = $(MAIN) DIO_program.c TIMER0_program.c LCD_program.c UART_program.c INTERRUPTS_program.c RTC_program.c TWI_program.c
MICROCNTRL = atmega16
...
.PHONY : flash
flash :
	$(PRO) -V -p $(MICROCNTRL) -c usbasp -U flash:w:main.o
